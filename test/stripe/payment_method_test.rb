...
module Stripe
  class PaymentMethodTest < Test::Unit::TestCase
    should "be listable" do
      ...
      assert_requested :get, "#{Stripe.api_base}/v1/payment_methods"
    ...
    context "#attach" do
      should "attach payment_method" do
        ...
        assert_requested :post,
                         "#{Stripe.api_base}/v1/payment_methods/#{payment_method.id}/attach"
        assert payment_method.is_a?(Stripe::PaymentMethod)
      end
    end
    ...
    context "#detach" do
      should "detach payment_method" do
        ...
        assert_requested :post,
                         "#{Stripe.api_base}/v1/payment_methods/#{payment_method.id}/detach"
        assert payment_method.is_a?(Stripe::PaymentMethod)
      end
    end
  end
